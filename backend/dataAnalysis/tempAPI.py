...
startDate = '09-01-2024'      # Start of the date range for  which to extract data: MM-DD-YYYY
endDate = '12-01-2024'        # End of the date range for  which to extract data: MM-DD-YYYY
